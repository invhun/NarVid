...
class VATEX_DataLoader(Dataset):
    ...
    def __init__(
        ...
        query_file = os.path.join(self.data_path, "vatex_data.json")
        ...
        for video_id in video_ids:
            ...
            for cap in queries[video_id]['enCap']:
    ...
    def _get_rawframes(self, choice_video_ids):
        ...
        for i, video_id in enumerate(choice_video_ids):
            frames_path = os.path.join(self.features_path, self.subset, "{}".format(video_id))
